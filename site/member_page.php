							...
							<!-- Content -->
								...
								<section id="banner">
									<div class="content">
										...
										<p><b><?php echo ($valid_code ? '<del>$250</del> $200' : '$250' ) ?> or <?php echo ($valid_code ? '<del>' . $final_cost_one_time . '</del> ' . $final_cost_one_time_discount : $final_cost_one_time ) ?> BTC</b></p>
